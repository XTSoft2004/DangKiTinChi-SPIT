  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-800 mb-2">Chào mừng trở lại</h2>
        <p className="text-sm sm:text-base text-slate-600">Vui lòng nhập thông tin để đăng nhập</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <Button
          type="button"
          variant="outline"
          className="h-12 border-gray-300 hover:bg-gray-50 hover:border-emerald-300 transition-colors"
        >
